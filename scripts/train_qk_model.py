...
from qml_qtl_pytorch_mnist.models.backbone import QuantumBackboneQiskit
...
if __name__ == "__main__":
    ...
    model = Classifier(n_quantum_layers=1, backbone_cls=QuantumBackboneQiskit)
    ...
    visualizer.save_loss_curve(
        ...
        losses=epoch_losses,
        filename="qk_training_loss.png",
    )

    save_path = "./data/results/qk_model.pth"
    torch.save(model.state_dict(), save_path)
    print(f"Qiskit model saved to {save_path}")
